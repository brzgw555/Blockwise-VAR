...
class VQVAE(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.dropout=0.0
        self.beta=1.0# commitment loss weight
        self.using_znorm=False# whether to normalize when computing the nearest neighbors
        self.quant_conv_ks=3# quant conv kernel size
        ...
        ddconfig = dict(
            dropout=self.dropout, ch=args.ch, z_channels=args.z_channels,
